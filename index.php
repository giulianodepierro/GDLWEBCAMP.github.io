...
<section class="seccion contenedor">
    ...
    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Praesentium iste assumenda porro labore dicta iusto recusandae, ex veniam natus necessitatibus facere nemo? Corrupti inventore aut placeat quam in dolor repudiandae?</p>
</section>
<!--seccion-->
...
<section class="programa">
    <div class="contenedor-video">
        <video autoplay loop poster="img/bg-talleres.jpg">
            ...
            <source src="video/video.webm" type="videp/webm">
        </video>
        <!--Contenedor Video-->
        ...
        <ul class="lista-precios clearfix">
            ...
            <li>
                <div class="tabla-precios">
                    ...
                    <p class="numero">$45</p>
                    <ul>
                        <li><i class="fas fa-check"></i>Bocadillos Gratis</li><br>
                        <li><i class="fas fa-check"></i>Todas las Conferencias</li>
                        <li><i class="fas fa-check"></i>Todos los talleres</li>
                    </ul>
...
<section class="seccion">
    ...
    <div class="testimoniales contenedor clearflix">
        ...
        <div class="testimonial">
            <blockquote>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin augue metus, dapibus vel ornare ut, tristique </p>
            </blockquote>
    ...
    <!--testimoniales contenedor cllearfix-->
...
<section class="seccion contenedor">
    ...
    <form id="registro" class="registro" action="index.html" method="POST">
        ...
        <ul class="lista-precios clearfix">
            ...
            <li>
                <div class="tabla-precios">
                    <h3>Todos los Dias(viernes y sabado)</h3>
                    <p class="numero">$50</p>
                    <ul>
                        <li><i class="fas fa-check"></i>Bocadillos Gratis</li>
                        <li><i class="fas fa-check"></i>Todas las Conferencias</li>
            ...
            <div class="caja clearfix">
                <div class="extras">
                    <div class="orden">
                        ...
                        <label for="etiqueta">Etiquetas del evento $10 </label>
                        <input type="number " min="0" id="etiqueta" size="3" placeholder="0">

                    </div>
                    <!---orden-->
                    <div class="orden">
                        <label for="regalo">Selecion un regalo</label>
